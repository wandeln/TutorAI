...
optional die lokal gespiegelten Libs Chart.js / Three.js) und antwortet als
...
- Verwende AUSSCHLIESSLICH diese Bibliotheken plus Vanilla JS, Canvas, SVG und CSS. KEINE anderen externen Ressourcen: keine weiteren CDN-Links, kein fetch/XHR, keine Bilder von URLs, keine ES-Modules (kein type="module"), keine Import-Maps.
